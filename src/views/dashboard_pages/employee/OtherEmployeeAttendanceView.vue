<template>
    ...
    giveAttendance(){
      ...
      for( var attendance of this.attendances){
        ...
        if(attendance.date==this.currentDate){
          ...
          this.newattendances.push(attendanceg);
  ...
  if(this.uuid!=""){
    ...
    axios
            .put("/employee/attendances/"+this.uuid, {
              ...
              attendances: JSON.stringify(this.newattendances),
            })
            .then((response) => {
              if (response) {
  ...
  this.selectedMonth=this.currentMonthName
    ...
    getAttendance(){
      axios
            .get("/employee/attendances/getbymonthid/"+this.selectedMonth+"/"+this.selectedYear+"/"+this.id)
            .then((response) => {
              if (response) {

                ...
                <form>
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-lg-3">
                        <div class="form-group">
                          <label for="exampleInputFile">Upload front side </label>
                          <div class="input-group">
                            <div class="custom-file">
                              <input
                                type="file"
                      ...
                      <div class="col-lg-3">
                        <div class="form-group">
                          <label for="exampleInputFile">Upload back side </label>
                          <div class="input-group">
                            <div class="custom-file">
                              <input
                                type="file"

                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <h5>{{ basic_information.first_name }} {{ basic_information.middle_name }} {{ basic_information.last_name }}</h5>
                        <p>{{ basic_information.email }}</p>
                      </div>
                      <div class="col-lg-5">
                        <!-- <router-link
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        <h5>Basic Info</h5>
                        <p><strong> Father's name:</strong> {{ basic_information.father_name }}</p>
                        <p><strong> Mother's name :</strong> {{ basic_information.mother_name }}</p>
                        <p><strong> Date of Birth :</strong> {{ basic_information.dob }}</p>
                        <p><strong> Contact Number :</strong> {{ basic_information.contact_number }}</p>

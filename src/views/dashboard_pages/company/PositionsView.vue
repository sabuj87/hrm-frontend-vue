           ...
           <div class="form-group">
             <label>Level</label>
                          ...
                          >
                            ...
                            <option v-for="level in levels" :key="level" :value="level.id">{{level.level_name}}</option>
                          </select>
                          <p class="text-danger mt-1" v-if="errors.level_id" >{{ errors.level_id[0] }}</p>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text"   @input="errors.position_name=null"  v-model="position_name" class="form-control" />
